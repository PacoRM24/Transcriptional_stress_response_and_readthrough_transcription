...
data_fold_change = np.log2((data_combined["THZ1"] + sc) / (data_combined["DMSO"] + sc))
...
expression_data.to_csv("ARTDeco_Pan_cells_Tabla_de_expresion_de_THZ1.csv", index= False)
